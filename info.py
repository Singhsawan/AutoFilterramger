...
API_ID = int(environ.get('API_ID', '23400324'))
API_HASH = environ.get('API_HASH', '6dd43d5bba765cfe72191bf60e65926f')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6981181936 6053231890').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001848838826') # support group id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://RagnarDiscussion:<password>@cluster0.llxeum4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AI_LOGS = int(environ.get("AI_LOGS", "0")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002124436497')) #Log channel id ( make sure bot is admin )
...
URL = "https://{ragnardiscussion-9260f30a3b61}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{ragnardiscussion-9260f30a3b61}/".format(FQDN, PORT)
