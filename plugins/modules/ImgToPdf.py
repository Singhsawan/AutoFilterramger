...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6884897048:AAEL83h6bcMqZxSoSutmwnxFTHoDzVAHAHM")

API_ID = int(os.environ.get("API_ID", 23400324))

API_HASH = os.environ.get("API_HASH", "6dd43d5bba765cfe72191bf60e65926f")
app = Client(
        "pdf",
